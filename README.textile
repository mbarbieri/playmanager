...
Play! Manager is a Web-Application (based on the Java Play! Framework) for managing Play! Applications. Similar to the Tomcat-Manager, but instead of deploying a .war File you deploy your zipped Play Application. You can start, stop, deploy, redeploy the Applications. Addionally you can access the log file and the status of your Applications.
...
It is highly recommend to change those settings, which you find find also in the /conf/application.conf.
